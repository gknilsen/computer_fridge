...
# Python deep fridge data logger for test #2
...
while time_stamp < 900:
    ...
    # Start CPU after 5 minutes, leave it on max for 5 minutes
    if time_stamp > 300 and cpugpu_started != True:
        p1 = subprocess.Popen(args=('stress', '-t', '300', '--cpu', '12'))#, stdout=subprocess.PIPE)
        cpugpu_started = True
