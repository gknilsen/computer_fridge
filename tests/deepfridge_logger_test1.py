...
# -*- coding: utf-8 -*-
"""
Created on Thu Aug  8 09:17:50 2019

@author: gni021
"""


# Python deep fridge data logger for test #1
...
dev = '/dev/ttyACM0'
baud_rate = 9600
path = '/home/gni021/deep_fridge/%s' % sys.argv[1]
file = open(path,'w')
...
while time_stamp < 3600:
    ...
    # Start compressor after 5 minutes
    if time_stamp > 300 and compressor_running != True:
        ser.write('1'.encode())
